...
(custom-set-variables
 ...
 '(package-selected-packages
   '(magit magit-popup company-fuzzy helm-company elpy omnisharp realgud-lldb helm-make csharp-mode dired-rainbow lolcat rainbow-blocks rainbow-delimiters rainbow-identifiers helm-lsp vhdl-capf vhdl-tools lsp-mode company helm use-package doom-themes doom-modeline ace-window)))
 '(custom-safe-themes
   (quote
